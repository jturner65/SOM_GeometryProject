...
public abstract class SOM_GeomObjBldrRunner extends myThreadRunner {
	 ...
	 */
	public SOM_GeomObjBldrRunner(SOM_GeomMapManager _mapMgr, ExecutorService _th_exec, SOM_GeomObj[] _objArray, String _dataTypName, boolean _forceST, int[] _numVals, SOM_GeomObjBldrTasks _taskType) {
