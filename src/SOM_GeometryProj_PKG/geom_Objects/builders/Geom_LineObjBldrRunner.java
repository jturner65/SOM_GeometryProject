...
public class Geom_LineObjBldrRunner extends SOM_GeomObjBldrRunner {
	...
	public Geom_LineObjBldrRunner(SOM_MapManager _mapMgr, ExecutorService _th_exec, String _dataTypName,	boolean _forceST, int _numObjs, int _taskType) {
