...
public class Geom_3DLineCSVDataLoader extends SOM_ExCSVDataLoader {
	protected final SOM_ExDataType exType;
	public Geom_3DLineCSVDataLoader(SOM_GeomMapManager _mapMgr, int _thdIDX, String _fileName, String _yStr, String _nStr, SOM_ExDataType _exType, ConcurrentSkipListMap<String, SOM_Example> _mapToAddTo) {
		super(_mapMgr, _thdIDX, _fileName, _yStr, _nStr, _mapToAddTo);
		type="line3DCSVDataLoader";
		exType=_exType;
	}

	@Override
	//Geom_LineSOMExample(SOM_GeomMapManager _mapMgr, SOM_ExDataType _exType, String _oid, String _csvDat)
	protected SOM_Example buildExample(String oid, String str) {		return new Geom_3DLineSOMExample((Geom_3DLineMapMgr)mapMgr,exType, oid, str);}
