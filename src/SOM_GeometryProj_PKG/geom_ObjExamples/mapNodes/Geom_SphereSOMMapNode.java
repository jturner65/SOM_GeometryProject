...
public class Geom_SphereSOMMapNode extends SOM_GeomMapNode {
	...
	public Geom_SphereSOMMapNode(SOM_MapManager _map, Tuple<Integer, Integer> _mapNodeLoc, float[] _ftrs) {
		super(_map, _mapNodeLoc, _ftrs);
		// TODO Auto-generated constructor stub
	}

	public Geom_SphereSOMMapNode(SOM_MapManager _map, Tuple<Integer, Integer> _mapNodeLoc, String[] _strftrs) {
